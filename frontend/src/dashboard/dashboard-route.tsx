    ...
    <Container>
      {authenticated ? (
        ...
        <TextContent>
          ...
          <Text>
            <br></br>
            Do you have a problem with managing volleyball tournaments? The{" "}
            <b>TOURNAMENT4YOU</b> application will surely solve it.
            <br></br>
            <br></br>
            This web application is designed for people who want to set{" "}
            <b>voleyball tournaments</b>!
          </Text>
          <Image>
            <img src={images.VoleyballTournamentLogo} alt="logo" />
          </Image>
          <Text>
            Create a volleyball <b>event</b>, add <b>teams</b> to it, enter{" "}
            <b>players</b> and transparently follow the tournament, completing
            the results on a regular basis.
            <br></br>
            <br></br>
            Thanks to the gameplay tree, following the tournament will become
            much simpler and more transparent.
            <br></br>
            <br></br>
            Don't wait any longer! Create <b>an account</b> to be able to use
